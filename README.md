...
Containers for tools in this respository are built using 'docker build' and not 'planemo mull' as they have dependencies not supported through bioconda. 
